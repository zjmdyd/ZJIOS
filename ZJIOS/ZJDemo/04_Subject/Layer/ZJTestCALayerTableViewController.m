...
- (void)initAry {
    self.cellTitles = @[@"ZJTestLayerBorderViewController", @"ZJTestLayerMaskViewController", @"ZJTestCAGradientLayerViewController", @"ZJAnchorPointViewController", @"ZJTestTouchViewController",];
}
