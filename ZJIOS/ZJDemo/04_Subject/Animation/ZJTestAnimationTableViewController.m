...
- (void)initAry {
    self.cellTitles = @[@"ZJTransform2DTableViewController", @"ZJCATransform3DTypeTableViewController", @"ZJTestBasicAnimationViewController", @"ZJCAReplicatorTableViewController", @"ZJUIAttachmentBehaviorViewController", @"ZJUIGravityBehaviorViewController",  @"ZJTestPushTransitionTableViewController", @"ZJTestPopTransitionTableViewController", ];
}
