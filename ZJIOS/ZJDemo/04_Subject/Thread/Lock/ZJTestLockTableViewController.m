...
/*
 五、锁机制对比
 锁类型    特性    性能（纳秒级）
 OSSpinLock    忙等待锁，已弃用（优先级反转问题）    10ns
 os_unfair_lock    替代OSSpinLock，非忙等待    15ns
 pthread_mutex    通用互斥锁，支持递归    30ns
 NSLock    对pthread_mutex的封装    50ns
 @synchronized    语法糖，自动异常处理    100ns
