...
- (void)initAry {
    self.cellTitles = @[@"test0", @"test1", @"test2", @"test3", @"test4", @"test5", @"testDispatch_group", @"testDispatch_group2", @"testBlockMainThread", @"test6", @"testBarrier", @"test_dispatch_apply"];
}
...
- (void)test6 {
    [self showVCWithName:@"ZJTestThreadSafeViewController"];
}

- (void)testBarrier {
    [self showVCWithName:@"ZJTestGCDBarrierTableViewController"];
}
