//
//  ZJTransClearChoosePhotoTableViewController.m
//  AoShiTong
//
...
@interface ZJTransClearChoosePhotoTableViewController ()

@end

@implementation ZJTransClearChoosePhotoTableViewController
